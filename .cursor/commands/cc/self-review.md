---
description: >-
  [cc: alias] [INTERNAL] Self-review of the CodeConductor product (security,
  implementation, workflow, features, mental model). Not part of consumer
  workflows. Alias of /cc-self-review.
---
