...
RDD complements this gate: capture the candidate receipt before Mutation Testing
and verify it after the runner restores production source. A survivor opens a
new tester/reviewer-approved test revision; it never makes an earlier receipt
valid again.
