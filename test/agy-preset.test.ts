...
describe('Antigravity CLI (agy) Manifest and Model Config', () => {
  test('manifest loads successfully and contains correct entries', async () => {
    ...
    expect(srcDirs).toContain('opencode/prompts/v0.5.0');
    expect(srcDirs).toContain('opencode/prompts/v0.6.0');
    ...
    expect(destDirs).toContain('.agents/prompts/v0.5.0');
    expect(destDirs).toContain('.agents/prompts/v0.6.0');
  });
