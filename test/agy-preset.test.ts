...
describe('Antigravity CLI (agy) Preset — file existence', () => {
  const expectedPaths = [
    ...
    'presets/agy/workflows/cc-spec-mutation.md',
    'presets/agy/workflows/cc-api-contract.md',
    'presets/agy/workflows/cc-db-migration.md',
    'presets/agy/workflows/cc-pagespeed.md',
    'presets/agy/workflows/cc-iterative.md',
    'presets/agy/workflows/cc-explore.md',
    'presets/agy/workflows/cc-triage.md',
    'presets/agy/workflows/cc-prototype.md',
    'presets/agy/workflows/cc-handoff.md',
    'presets/agy/workflows/cc-clarify.md',
    'presets/agy/settings.json',
    'presets/agy/hooks.json',
    'presets/agy/mcp_config.json',
    'presets/agy/scripts/invoke-hook.cjs',
    ...
    'presets/agy/skills/cc-spec-mutation/SKILL.md',
...
describe('Antigravity CLI (agy) Manifest and Model Config', () => {
  test('manifest loads successfully and contains correct entries', async () => {
    ...
    expect(srcDirs).toContain('opencode/prompts/v1.0.0');
